...
introduction: |
    ...
    **Product Manager**, **Blackthorn.io**  
    ...
    - **Rapid Tooling & Delivery:** Vibe-coded a zero-cost public roadmap platform in <1 day using Claude Code, replacing a deprecated vendor tool by automating Google Sheets data into brand-compliant HTML published via GitHub Pages, eliminating third-party tool procurement for the Product team.
